...
**Критерии приёмки:**
- [ ] Core всегда в контексте
- [ ] Recall возвращает релевантные прошлые эпизоды по запросу
- [ ] Размер контекста не раздувается (лимиты соблюдены)

**Зависимости:** 1.3 (Forgetting curves) — применять salience к Recall результатам.
